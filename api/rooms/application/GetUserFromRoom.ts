...
import GetUserFromRoomResponse, {
  GetUserFromRoomResponseSerialized
} from './GetUserFromRoomResponse'
...
export default class GetUserFromRoom {
  ...
  async dispatch(
    query: GetUserFromRoomQuery
  ): Promise<GetUserFromRoomResponseSerialized | null> {
